            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                         src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-4.jpg')); ?>"
                         alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#"><i class="bx bx-lock-open font-size-16 align-middle me-1"></i>
                        <span key="t-lock-screen"><?php echo app('translator')->get('translation.Lock_screen'); ?></span></a>
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <a href="<?php echo e(route('continuous.index')); ?>" class="dropdown-item" key="t-chat">Penilaian
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <a href="<?php echo e(route('grade.vocationals.create')); ?>" class="dropdown-item" key="t-chat">Vokasional</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <a href="<?php echo e(route('users.index')); ?>" class="dropdown-item" key="t-chat">Pengguna</a>
...
<?php /**PATH /home/herwan/dev/apkv-web-5/resources/views/layouts/horizontal.blade.php ENDPATH**/ ?>