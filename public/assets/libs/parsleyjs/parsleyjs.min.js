!function (t, e) {
    ...
    var n = 1, s = {}, a = {
        attr: function (t, e, i) {
            ...
            if ("object" != e(t)) throw TypeError("Argument must be an object");
            o.prototype = t;
            var i = new o;
            return o.prototype = null, i
    ...
    l.prototype = {
        asyncSupport: !0, _pipeAccordingToValidationResult: function () {
            function e() {
                var e = t.Deferred();
                return !0 !== i.validationResult && e.reject(), e.resolve().promise()
            }
            ...
            for (var e in this.domOptions = a.objectCreate(this.parent.options), this.options = a.objectCreate(this.domOptions), t) t.hasOwnProperty(e) && (this.options[e] = t[e]);
        ...
        validate: function (t, e) {
            ...
            if (Array.isArray(r)) {
                for (var n = function (t, e) {
                    ...
                    return r
                }(e, r.length), s = 0; s < n.length; s++) n[s] = a.parseRequirement(r[s], n[s]);
                return n
            }
    ...
    function f(t, e) {
        return function (i) {
            for (var n = arguments.length, s = new Array(1 < n ? n - 1 : 0), o = 1; o < n; o++) s[o - 1] = arguments[o];
            return s.pop(), e.apply(void 0, [i].concat(r((l = t, s.map(a.parse[l])))));
            var l
        }
    }
    ...
    c.range = c.number, h.prototype = {
        init: function (t, e) {
            for (var r in this.catalog = e, this.validators = i({}, this.validators), t) this.addValidator(r, t[r].fn, t[r].priority);
            window.Parsley.trigger("parsley:validator:init")
        }, setLocale: function (t) {
            if (void 0 === this.catalog[t]) throw new Error(t + " is not available in the catalog");
            return this.locale = t, this
        }, addCatalog: function (t, i, r) {
            return "object" === e(i) && (this.catalog[t] = i), !0 === r ? this.setLocale(t) : this
            ...
            if (this.validators[t]) a.warn('Validator "' + t + '" is already defined.'); else if (u.hasOwnProperty(t)) return void a.warn('"' + t + '" is a restricted keyword and is not a valid validator name.');
        ...
        }, _setValidator: function (t, i, r) {
            for (var n in "object" !== e(i) && (i = {
                fn: i,
                priority: r
            }), i.validate || (i = new d(i)), (this.validators[t] = i).messages || {}) this.addMessage(n, t, i.messages[n]);
            return this
            ...
            if ("object" !== e(i)) return "string" == typeof t ? t.replace(/%s/i, i) : "";
            for (var r in i) t = this.formatMessage(t, i[r]);
            return t
        }, validators: {
            notblank: {
    ...
    g.Form = {
        ...
        _reflowUI: function () {
            ...
            if (void 0 === this.options.errorsMessagesDisabled) {
                if (void 0 !== this.options.errorMessage) return e.added.length || e.kept.length ? (this._insertErrorWrapper(), 0 === this._ui.$errorsWrapper.find(".parsley-custom-error-message").length && this._ui.$errorsWrapper.append(t(this.options.errorTemplate).addClass("parsley-custom-error-message")), this._ui.$errorClassHandler.attr("aria-describedby", this._ui.errorsWrapperId), this._ui.$errorsWrapper.addClass("filled").attr("aria-hidden", "false").find(".parsley-custom-error-message").html(this.options.errorMessage)) : (this._ui.$errorClassHandler.removeAttr("aria-describedby"), this._ui.$errorsWrapper.removeClass("filled").attr("aria-hidden", "true").find(".parsley-custom-error-message").remove());
            ...
            var r = i.message, n = i.assert;
            this._insertErrorWrapper(), this._ui.$errorClassHandler.attr("aria-describedby", this._ui.errorsWrapperId), this._ui.$errorsWrapper.addClass("filled").attr("aria-hidden", "false").append(t(this.options.errorTemplate).addClass("parsley-" + e).html(r || this._getErrorMessage(n)))
            ...
            if ("string" == typeof this.options.classHandler && "function" == typeof window[this.options.classHandler] && (i = window[this.options.classHandler]), "function" == typeof i) {
                ...
                if ("object" === e(i) && i instanceof jQuery && i.length) return i;
            ...
            if ("string" == typeof i) {
                if (t(i).length) return t(i).append(this._ui.$errorsWrapper);
                "function" == typeof window[i] ? i = window[i] : a.warn("The errors container `" + i + "` does not exist in DOM nor as a global JS function")
            }
            return "function" == typeof i && (i = i.call(this, this)), "object" === e(i) && i.length ? i.append(this._ui.$errorsWrapper) : this._inputHolder().after(this._ui.$errorsWrapper)
        }, _actualizeTriggers: function () {
    ...
    function _(t, e, r, n, s) {
        var a = new d(window.Parsley._validatorRegistry.validators[e]);
        i(this, {
            validator: a,
            name: e,
            requirements: r,
    ...
    v.prototype = {
        onSubmitValidate: function (t) {
            ...
            if (!1 !== this._trigger("submit")) {
                if (e) {
                    ...
                    0 === r.length && (r = t('<input class="parsley-synthetic-submit-button" type="hidden">').appendTo(this.$element)), r.attr({
                        name: e.getAttribute("name"),
                        value: e.getAttribute("value")
                    })
                }
                this.$element.trigger(i(t.Event("submit"), {parsley: !0}))
            }
        }, validate: function (e) {
            if (1 <= arguments.length && !t.isPlainObject(e)) {
            ...
            var n, s = this, o = 0 < arguments.length && void 0 !== e ? e : {}, l = o.group, u = o.force, d = o.event;
            (this.submitEvent = d) && (this.submitEvent = i({}, d, {
                preventDefault: function () {
                    a.warnOnce("Using `this.submitEvent.preventDefault()` is deprecated; instead, call `this.validationResult = false`"), s.validationResult = !1
                }
            })), this.validationResult = !0, this._trigger("validate"), this._refreshFields();
            var h = this._withoutReactualizingFormOptions((function () {
                return t.map(s.fields, (function (t) {
                    return t.whenValidate({force: u, group: l})
                }))
            }));
            return (n = a.all(h).done((function () {
                s._trigger("success")
            })).fail((function () {
                s.validationResult = !1, s.focus(), s._trigger("error")
            })).always((function () {
                s._trigger("validated")
            }))).pipe.apply(n, r(this._pipeAccordingToValidationResult()))
        }, isValid: function (e) {
            if (1 <= arguments.length && !t.isPlainObject(e)) {
        ...
        }, whenValid: function (e) {
            var i = this, r = 0 < arguments.length && void 0 !== e ? e : {}, n = r.group, s = r.force;
            this._refreshFields();
            var o = this._withoutReactualizingFormOptions((function () {
                return t.map(i.fields, (function (t) {
                    return t.whenValid({group: n, force: s})
                }))
            }));
            return a.all(o)
        }, refresh: function () {
    ...
    var w = {
        pending: null, resolved: !0, rejected: !(_.prototype = {
            validate: function (t, e) {
                var i;
                ...
                this.requirementList = this.validator.parseRequirements(this.requirements, (function (i) {
                    return t[e.name + ((r = i)[0].toUpperCase() + r.slice(1))];
                    var r
                }))
            }
        })
    ...
    function C(r, n, s) {
        this.element = r, this.$element = t(r);
        var a = this.$element.data("Parsley");
        if (a) return void 0 !== s && a.parent === window.Parsley && (a.parent = s, a._resetOptions(a.options)), "object" === e(n) && i(a.options, n), a;
        if (!this.$element.length) throw new Error("You must bind Parsley on an existing element.");
        if (void 0 !== s && "Form" !== s.__class__) throw new Error("Parent instance must be a Form instance");
        return this.parent = s || window.Parsley, this.init(n)
    }

    b.prototype = {
        validate: function (e) {
            1 <= arguments.length && !t.isPlainObject(e) && (a.warnOnce("Calling validate on a parsley field without passing arguments as an object is deprecated."), e = {options: e});
            ...
            var e, i = this, n = 0 < arguments.length && void 0 !== t ? t : {}, s = n.force, a = n.group;
            if (this.refresh(), !a || this._isInGroup(a)) return this.value = this.getValue(), this._trigger("validate"), (e = this.whenValid({
                force: s,
                value: this.value,
                _refreshed: !0
            }).always((function () {
            ...
            var i = this, r = 0 < arguments.length && void 0 !== e ? e : {}, n = r.force, s = void 0 !== n && n,
                o = r.value, l = r.group;
            if (r._refreshed || this.refresh(), !l || this._isInGroup(l)) {
                if (this.validationResult = !0, !this.hasConstraints()) return t.when();
                if (null == o && (o = this.getValue()), !this.needsValidation(o) && !0 !== s) return t.when();
                var u = this._getGroupedConstraints(), d = [];
                return t.each(u, (function (e, r) {
            ...
            var r = this, n = i.validate(e, this);
        ...
        init: function (t) {
            return this.__class__ = "Parsley", this.__version__ = "2.9.2", this.__id__ = a.generateID(), this._resetOptions(t), "FORM" === this.element.nodeName || a.checkAttr(this.element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        }, isMultiple: function () {
            ...
            for (var n = this._findRelated(), s = 0; s < n.length; s++) if (void 0 !== (i = t(n.get(s)).data("Parsley"))) {
            ...
            switch (e) {
                case"parsleyForm":
                    r = t.extend(new v(this.element, this.domOptions, this.options), new l, window.ParsleyExtend)._bindFields();
                    break;
                case"parsleyField":
                    r = t.extend(new b(this.element, this.domOptions, this.options, this.parent), new l, window.ParsleyExtend);
                    break;
                case"parsleyFieldMultiple":
                    r = t.extend(new b(this.element, this.domOptions, this.options, this.parent), new F, new l, window.ParsleyExtend)._init();
                    break;
                default:
                    throw new Error(e + "is not a supported Parsley type")
            }
            return this.options.multiple && a.setAttr(this.element, this.options.namespace, "multiple", this.options.multiple), void 0 !== i ? this.$element.data("FieldMultiple", r) : (this.$element.data("Parsley", r), r._actualizeTriggers(), r._trigger("init")), r
        }
    };
    ...
    i(b.prototype, g.Field, l.prototype), i(v.prototype, g.Form, l.prototype), i(C.prototype, l.prototype), t.fn.parsley = t.fn.psly = function (e) {
        if (1 < this.length) {
            var i = [];
        ...
        if (0 != this.length) return new C(this[0], e)
    }, void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}), E.options = i(a.objectCreate(u), window.ParsleyConfig), window.ParsleyConfig = E.options, window.Parsley = window.psly = E, E.Utils = a, window.ParsleyUtils = {}, t.each(a, (function (t, e) {
    ...
    window.ParsleyValidator = {}, t.each("setLocale addCatalog addMessage addMessages getErrorMessage formatMessage addValidator updateValidator removeValidator hasValidator".split(" "), (function (t, e) {
        window.Parsley[e] = function () {
            ...
            var t;
            return a.warnOnce("Accessing the method '".concat(e, "' through Validator is deprecated. Simply call 'window.Parsley.").concat(e, "(...)'")), (t = window.Parsley)[e].apply(t, arguments)
        }
    })), window.Parsley.UI = g, window.ParsleyUI = {
        removeError: function (t, e, i) {
            var r = !0 !== i;
            return a.warnOnce("Accessing UI is deprecated. Call 'removeError' on the instance directly. Please comment in issue 1073 as to your need to call this method."), t.removeError(e, {updateClass: r})
        ...
        window.ParsleyUI[e] = function (t, i, r, n, s) {
            var o = !0 !== s;
            return a.warnOnce("Accessing UI is deprecated. Call '".concat(e, "' on the instance directly. Please comment in issue 1073 as to your need to call this method.")), t[e](i, {
                message: r,
                assert: n,
                updateClass: o
            })
    ...
    return t.listen = function (t, i) {
        var r;
        if ($(), "object" === e(arguments[1]) && "function" == typeof arguments[2] && (r = arguments[1], i = arguments[2]), "function" != typeof i) throw new Error("Wrong parameters");
        window.Parsley.on(T(t), P(i, r))
    }, t.listenTo = function (t, e, i) {
        if ($(), !(t instanceof b || t instanceof v)) throw new Error("Must give Parsley instance");
        ...
        $(), window.Parsley.off(T(e)), t("form,input,textarea,select").each((function () {
            var i = t(this).data("Parsley");
            i && i.off(T(e))
        }))
    }, t.emit = function (t, e) {
        $();
        var i = e instanceof b || e instanceof v, n = Array.prototype.slice.call(arguments, i ? 2 : 1);
        n.unshift(T(t)), i || (e = window.Parsley), e.trigger.apply(e, r(n))
    }, t.extend(!0, E, {
        asyncValidators: {
            default: {
                fn: function (t) {
            ...
            return E.asyncValidators[t] = {fn: e, url: i || !1, options: r || {}}, this
        }
        ...
        requirementType: {
            ...
            var s, a, o = {}, l = r.validator || (!0 === r.reverse ? "reverse" : "default");
            if (void 0 === E.asyncValidators[l]) throw new Error("Calling an undefined async validator: `" + l + "`");
            -1 < (i = E.asyncValidators[l].url || i).indexOf("{value}") ? i = i.replace("{value}", encodeURIComponent(e)) : o[n.element.getAttribute("name") || n.element.getAttribute("id")] = e;
            var u = t.extend(!0, r.options || {}, E.asyncValidators[l].options);

            function d() {
                var e = E.asyncValidators[l].fn.call(n, h, i, r);
            ...
            s = t.extend(!0, {}, {
                ...
                data: o,
                type: "GET"
            }, u), n.trigger("field:ajaxoptions", n, s), a = t.param(s), void 0 === E._remoteCache && (E._remoteCache = {});
            var h = E._remoteCache[a] = E._remoteCache[a] || t.ajax(s);
            return h.then(d, d)
        }, priority: -1
        ...
        i(this, {
            isNativeEvent: function (t) {
                ...
                if (!r.inputEventPatched) {
                    ...
                    for (var i = 0, n = ["select", 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]']; i < n.length; i++) {
                        var s = n[i];
                        t(document).on("input.inputevent", s, {selector: s}, e.behavesOk).on("change.inputevent", s, {selector: s}, e.misbehaves)
                    }
                }
            }, uninstall: function () {
                delete r.inputEventPatched, t(document).off(".inputevent")
            }
        })
    }).install(), E
}));
